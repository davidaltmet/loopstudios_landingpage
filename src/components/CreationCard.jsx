function CreationCard({ image, titleCard }) {
  ...
  return (
    <div className="relative cursor-pointer overflow-hidden group">
      ...
      <div className="absolute bottom-0 left-0  w-1/2 flex items-center justify-center  h-full md:h-2/5 md:w-full bg-gray-950 py-4 px-4 md:py-2 md:px-4 xl:py-14 xl:px-10 -translate-x-full md:translate-x-0  md:translate-y-full md:group-hover:translate-y-0 group-hover:translate-x-0  opacity-0 group-hover:opacity-100 duration-300">
